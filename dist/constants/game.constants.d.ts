...
export declare const UPGRADE_COST_MULTIPLIER = 1.25;
...
export declare const LOOT_PERCENTAGE = 1;
...
export declare const VIP_PRICE_USDT_TON = 5;
export declare const VIP_DURATION_DAYS = 30;
export declare const PAYMENT_WALLET_ADDRESS = "UQBQeWT7nw0KjeKmSbxsmqqgDRh61H-_ZamVc3_I5S1jNX0T";
