...
__decorate([
    ...
    __metadata("design:type", String)
], LoginDto.prototype, "referralCode", void 0);
let AuthController = class AuthController {
    ...
    async login(dto) {
        try {
            ...
            throw new common_1.HttpException({ message: e?.message || 'Login failed', detail: e?.stack?.split('\n')[0] }, e?.status || common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
