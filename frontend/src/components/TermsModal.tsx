...
const LABELS: Record<string, { title: string; agree: string; scroll: string }> = {
...
function getTermsText(lang: string): string {
...
export default function TermsModal({ onAccepted }: Props) {
  ...
  const [lang, setLang] = useState(localStorage.getItem('kw_lang') || 'en');
