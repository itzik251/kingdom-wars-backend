...
FRONTEND_URL=http://187.124.49.18
MINI_APP_URL=http://187.124.49.18
CRYPTO_BOT_TOKEN=
`;

const cmd = `printf '%s' '${envFile.replace(/'/g, "'\\''")}' > /var/www/kingdom-wars/backend/.env
echo ENV_UPDATED
pm2 restart kingdom-wars
sleep 4
pm2 status
`;
